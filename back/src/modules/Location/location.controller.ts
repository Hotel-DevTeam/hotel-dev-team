...
export class LocationController {
  ...
  @ApiResponse({ status: 400, description: 'Error en la creación de la ubicación.' })
  ...
  @ApiResponse({ status: 400, description: 'Error en modificar de la ubicación.' })
  ...
  @ApiResponse({ status: 201, description: 'La habitación ha sido creada en la ubicación especifica.' })
  ...
  @ApiBearerAuth()
  @ApiOperation({ summary: 'Obtener las habitaciones de una ubicación específica' }) 
