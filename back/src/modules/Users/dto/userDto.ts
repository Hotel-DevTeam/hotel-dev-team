...
export class CreateUserDto {
  ...
  @ApiProperty({
    description:
      'El nombre del usuario, debe ser un string entre 3 y 50 caracteres',
    example: 'Conti',
  })
  @IsNotEmpty()
  @IsString()
  ...
  @ApiProperty({
    description:
      'La contraseña debe tener entre 8 y 15 caracteres, con al menos una letra minúscula, una letra mayúscula, un número y un carácter especial (!@#$%^&*)',
    example: 'aaBB12345#',
  })
  @IsNotEmpty()
  @IsString()
  ...
  @ApiProperty({
    description:
      'El rol del usuario debe ser uno de los siguientes: admin, receptionist, o employee',
    example: 'admin',
  })
  @IsEnum(Role, {
    message:
      'El rol debe ser uno de los siguientes: admin, receptionist, employee',
  })
  @IsNotEmpty()
  role: Role;
